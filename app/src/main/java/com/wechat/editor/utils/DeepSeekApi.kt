...
object DeepSeekApi {
     ...
     * [newsContextLines] is the same numbered list used by the digest writer; it is injected
     * once as the system prompt so subsequent turns remain lightweight.
     * [history] contains prior USER / ASSISTANT turns (excluding the new [userMessage]).
     */
